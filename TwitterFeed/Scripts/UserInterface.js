...
var query_twitter = function query_twitter(str_query) {
...
//event handlers
var handle_success = function handle_success(data) {
    tweets = data;
    tweets_shown = tweets;
...
//html renders
var render = function render(html_blob) {
    $('div#response').html(html_blob);
};

var highlight_html = function highlight_html(html_blob, highlight_str) {
    if (highlight_str == '') {
        return html_blob;
    }
...
var build_html = function build_html(tweets) {
...
var filter_tweets = function filter_tweets(tweets, str_query) {
...
//for testing..
var get_tweets = function get_tweets() {
    return tweets;
};

var get_tweets_shown = function get_tweets_shown() {
    return tweets_shown;
};